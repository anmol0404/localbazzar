...
export class ProductService {
  ...
  async createShopProduct(userId: string, data: CreateShopProductDTO) {
    ...
    // Create product
    // Note: We're skipping embedding generation for now as it requires OpenAI API key
    // In a real implementation, we would generate embedding here and insert via raw query
