...
export class ShopController {
  ...
  async getShopStats(req: AuthRequest, res: Response) {
    try {
      const userId = req.user!.userId;
      const stats = await shopService.getShopStats(userId);
  ...
  async getAllShops(req: Request, res: Response) {
    try {
      ...
      const result = await shopService.getAllShops({ page, limit, search, status });
